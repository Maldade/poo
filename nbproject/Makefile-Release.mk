...
${OBJECTDIR}/Classificacao.o: Classificacao.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Classificacao.o Classificacao.cpp
...
${OBJECTDIR}/GerenciarSegurados.o: GerenciarSegurados.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GerenciarSegurados.o GerenciarSegurados.cpp

${OBJECTDIR}/ListaApolice.o: ListaApolice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ListaApolice.o ListaApolice.cpp

${OBJECTDIR}/Marca.o: Marca.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Marca.o Marca.cpp
...
${OBJECTDIR}/TipoSinistro.o: TipoSinistro.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TipoSinistro.o TipoSinistro.cpp

${OBJECTDIR}/TipoVeiculo.o: TipoVeiculo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TipoVeiculo.o TipoVeiculo.cpp
...
${OBJECTDIR}/mainApolice.o: mainApolice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/mainApolice.o mainApolice.cpp
